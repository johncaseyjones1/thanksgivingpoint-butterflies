class ButterflyShipmentModel:
    ...
    def setShipmentID(ID):
        self.shipmentID = ID

    def setSpeciesID(ID):
        self.speciesID = ID

    def setDateEntered(date):
        self.dateEntered = date

    def setOrigin(origin):
        self.origin = origin

    def setQuantity(count):
        self.quantity = count

    def setSupplier(supplier):
        self.supplier = supplier

    def setEmergedEarly(emergedEarly):
        self.emergedEarly = emergedEarly

    def setDeadOnArrival(deadOnArrival):
        self.deadOnArrival = deadOnArrival

    def setFailedToEmerge(failedToEmerge):
        self.failedToEmerge = failedToEmerge

    def setParasitized(parasitized):
        self.parasitized = parasitized
